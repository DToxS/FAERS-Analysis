...
pdf(file="results/figure_External_predict_observed_for publication.pdf",height=6,width=6)
...
pdf("results/figure VIP scores final signature for publication.pdf",width=6,height=6)
...
pdf(file='results/figure_Obs_Pred_trainin for publication.pdf',width=6, height=6)
ggplot(data=sum)+
